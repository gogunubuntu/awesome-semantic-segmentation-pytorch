...
class SunrgbdResizedSegmentation(SegmentationDataset):
    ...
    def __init__(
        self,
        root="../datasets/sunrgbd_resized",
        split="test",
        mode=None,
        transform=None,
        **kwargs
    ):
        super(SunrgbdResizedSegmentation, self).__init__(
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            img = self.transform(img)
        # print("transformed", img.shape, mask.shape, type(img), type(mask))
...
if __name__ == "__main__":
    train_dataset = SunrgbdResizedSegmentation()
